...
public class ImageGraphics extends Node implements  Graphics {
     ...
     * @param d actual image width, before transformation
     * @param e actual image height, before transformation
     * @param anchor image anchor, not null
     */
    public ImageGraphics(String name, float d, float e, Vector anchor) {
        this(name, d, e, anchor, 1.0f, 0.0f);
    }
