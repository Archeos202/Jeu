...
public class HelloWorldGame implements Game {
    ...
    public boolean begin(Window window, FileSystem fileSystem) {
        ...
        // Tranparency can be chosen for each drawing (0.0 - transparent,
        // 1.0 -opaque)
        ...
        entityBuilder.setPosition(new Vector(10.0f, 1.5f));
    ...
    public void update(float deltaTime) {
        ...
        // a bit
        window.setRelativeTransform(Transform.I.scaled(15.0f));
