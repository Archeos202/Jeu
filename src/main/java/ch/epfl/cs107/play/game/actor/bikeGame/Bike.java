...
public class Bike extends GameEntity implements Actor {
	...
	public Bike(ActorGame game, Vector position) {
		...
		ContactListener listener = new ContactListener() {
			...
			public void beginContact(Contact contact) {
				...
				if ((contact.getOther() == leftWheel.getPart()) || (contact.getOther() == rightWheel.getPart())) {
					System.out.println("jeanj");
					return;
				}
				hit = true;
			}
	...
	private void BikerGraphics() {
		...
		Polyline thigh = new Polyline(getBottomLocation(), getKneeLocation());
		Polyline leftFoot = new Polyline(getKneeLocation(), getLeftFootLocation());
		Polyline rightFoot = new Polyline(getKneeLocation(), getRightFootLocation());
